 ...
 <div class="row" style="float: left;">
  <div class="col-6">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="contact" role="tab" aria-controls="messages">联系我们</a>
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="login" role="tab" aria-controls="settings">个人中心</a>
    </div>
  </div>
  <div class="col-6">
